            ...
            <div className="col-md-6 col-lg-2 d-none d-md-block">
              ...
              <div className="vstack small gap-2">
                <Link href="/auth/login">
                  <span className="footer-link">User Login</span>
                </Link>
                <Link href="/auth/sign-up">
                  <span className="footer-link">User Register</span>
                </Link>
                <Link href="/account/profile">
                  <span className="footer-link">Account Setting</span>
                </Link>
                <Link href="/account/current-orders">
                  <span className="footer-link">My Orders</span>
                </Link>
              </div>
            </div>
